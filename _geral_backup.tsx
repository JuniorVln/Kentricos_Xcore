...
const MATURITY_LEVELS = ['Inicial', 'Conscientiza├º├úo', 'Organizacional', 'Estrutura├º├úo', 'Proatividade'];

function getMaturityFromScore(score: number): string {
    if (score <= 30) return 'Inicial';
    if (score <= 60) return 'Conscientiza├º├úo';
    if (score <= 80) return 'Organizacional';
    if (score <= 90) return 'Estrutura├º├úo';
    return 'Proatividade';
}
        ...
        <div className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row justify-between items-end gap-6">
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-300 dark:text-gray-500 font-light">Monitoramento estrat├®gico de maturidade de leads.</p>
                </div>
                ...
                <div className="flex flex-wrap gap-4 items-center">
                    <div className="bg-white/60 dark:bg-[#1E293B]/60 backdrop-blur-md border border-white/50 dark:border-white/10 px-6 py-3 rounded-2xl shadow-xl flex items-center gap-4 group hover:bg-white dark:bg-[#1E293B]transition-all cursor-default">
                        ...
                        <div>
                            <div className="flex items-center gap-1.5">
                                <span className="text-[10px] text-gray-500 dark:text-gray-300 dark:text-gray-500 uppercase tracking-widest font-bold">Total Conclu├¡dos</span>
                                <div className="group/info relative z-50">
                                    ...
                                    <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-56 p-2.5 bg-[#0A0A0A] text-white text-[10px] rounded-xl opacity-0 group-hover/info:opacity-100 transition-opacity pointer-events-none border border-slate-700 drop-shadow-[0_10px_20px_rgba(0,0,0,0.8)] z-50">
                                        Reflete o total de empresas que finalizaram 100% do diagn├│stico e j├í possuem um Score de Maturidade calculado. Leads incompletos n├úo entram nesta contagem.
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="bg-white/60 dark:bg-[#1E293B]/60 backdrop-blur-md border border-white/50 dark:border-white/10 px-6 py-3 rounded-2xl shadow-xl flex items-center gap-4 group hover:bg-white dark:hover:bg-[#1E293B] transition-all cursor-default">
                        ...
                        <div>
                            <div className="flex items-center gap-1.5">
                                <span className="text-[10px] text-gray-500 dark:text-gray-400 uppercase tracking-widest font-bold">Score M├®dio</span>
                                <div className="group/info relative z-50">
                                    <Info size={10} className="text-gray-400 dark:text-gray-500" />
                                    <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-56 p-2.5 bg-[#0A0A0A] text-white text-[10px] rounded-xl opacity-0 group-hover/info:opacity-100 transition-opacity pointer-events-none border border-slate-700 drop-shadow-[0_10px_20px_rgba(0,0,0,0.8)] z-50">
                                        M├®dia geral de desempenho de todos os leads conclu├¡dos. Mostra o n├¡vel m├®dio de maturidade do seu banco de dados atual.
                                    </div>
                                </div>
                            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-auto lg:h-[380px]">
                ...
                <div className="lg:col-span-3 bg-gradient-to-b from-white/60 to-white/30 backdrop-blur-xl border border-white/50 dark:border-white/10 rounded-3xl p-5 shadow-xl flex flex-col justify-between relative overflow-hidden group h-full">
                    ...
                    <div className="relative z-10">
                        ...
                        <h3 className="text-xl font-bold text-brand-dark dark:text-gray-100">Relat├│rio XCore</h3>
                        <p className="text-sm text-gray-500 dark:text-gray-300 dark:text-gray-500 mt-1">An├ílise de maturidade em tempo real.</p>
                    </div>
                    ...
                    <div className="bg-white/50 dark:bg-[#1E293B]/50 rounded-2xl p-4 mt-6 backdrop-blur-sm border border-white/40 dark:border-white/10">
                        <div className="flex justify-between items-center mb-1 group/conv relative z-50">
                            ...
                            <div className="absolute top-full left-0 mt-2 w-64 p-3 bg-[#0A0A0A] text-white text-[10px] rounded-xl opacity-0 group-hover/conv:opacity-100 transition-opacity pointer-events-none border border-slate-700 drop-shadow-[0_10px_20px_rgba(0,0,0,0.8)] z-50">
                                <p className="font-bold text-brand-cyan mb-1">Como ├® calculado?</p>
                                ├ë a propor├º├úo de leads qualificados como <strong>Quentes (Hot)</strong> e <strong>Mornos (Warm)</strong> em rela├º├úo ao total da base. Indica a taxa prov├ível de sucesso comercial para prioriza├º├úo do time de vendas.
                            </div>
                        </div>
                        <p className="text-[10px] text-gray-400 dark:text-gray-500 mb-3 leading-tight">Proje├º├úo considerando o potencial de fechamento dos leads qualificados.</p>
                ...
                <div className="lg:col-span-3 bg-white/60 dark:bg-[#1E293B]/60 backdrop-blur-xl border border-white/50 dark:border-white/10 rounded-3xl p-6 shadow-xl flex flex-col justify-between group h-full">
                    <div>
                        <h3 className="text-xl font-bold text-brand-dark dark:text-gray-100 mb-4">L├│gica de Qualifica├º├úo</h3>
                        <div className="space-y-3">
                            {[
                                { label: 'Hot (Quente)', range: '70-100 pts', color: 'bg-amber-400', text: 'Alta prontid├úo tecnol├│gica e executiva.' },
                ...
                <div className="lg:col-span-3 bg-white/60 dark:bg-[#1E293B]/60 backdrop-blur-xl border border-white/50 dark:border-white/10 rounded-3xl p-6 shadow-xl flex flex-col relative h-full">
                    <div className="flex justify-between items-center mb-6">
                        <div>
                            <h3 className="text-xl font-bold text-brand-dark dark:text-gray-100">N├¡vel de Maturidade</h3>
                            <div className="flex items-baseline gap-2">
                                <span className="text-3xl font-light mt-1">
                                    {(metrics.avgScore / 20).toFixed(1)}
                                </span>
                                <span className="text-xs text-gray-500 dark:text-gray-300 dark:text-gray-500">M├®dia Geral (1-5)</span>
                            </div>
                        </div>
                ...
                <div className="lg:col-span-3 bg-white/60 dark:bg-[#1E293B]/60 backdrop-blur-xl border border-white/50 dark:border-white/10 rounded-3xl p-6 shadow-xl flex flex-col h-full">
                    <div className="flex justify-between items-start mb-4">
                        <h3 className="text-lg font-bold text-brand-dark dark:text-gray-100">Pontua├º├úo</h3>
                    ...
                    <div className="flex-1 flex items-center justify-center relative">
                        ...
                        <div className="w-[220px] h-[220px]" style={{ overflow: 'visible' }}>
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                                ...
                                <span className="text-xs text-gray-500 dark:text-gray-300 dark:text-gray-500 uppercase tracking-widest">Score M├®dio</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1 bg-white/40 backdrop-blur-xl border border-white/50 dark:border-white/10 rounded-3xl p-6 shadow-lg flex flex-col gap-5">
                    <div>
                        <h3 className="font-bold text-brand-dark dark:text-gray-100 mb-1">Autoavalia├º├úo vs. Diagn├│stico</h3>
                        <p className="text-xs text-gray-500 dark:text-gray-300 dark:text-gray-500 leading-relaxed">
                            Compara o n├¡vel que cada empresa declarou com o n├¡vel calculado pelo score real. Quanto mais na diagonal, maior o autoconhecimento.
                        </p>
                    </div>
                    <div className="space-y-3">
                        {[
                    ...
                    <p className="text-[10px] text-gray-400 dark:text-gray-500 leading-relaxed mt-auto">
                        <strong className="text-gray-500 dark:text-gray-300 dark:text-gray-500">Linha</strong> = n├¡vel declarado &nbsp;┬À&nbsp; <strong className="text-gray-500 dark:text-gray-300 dark:text-gray-500">Coluna</strong> = n├¡vel calculado pelo score
                    </p>
                </div>
                ...
                <div className="lg:col-span-2 bg-[#1E293B] text-white rounded-3xl p-6 shadow-2xl relative overflow-hidden">
                    <div className="flex items-center gap-2 mb-5 relative z-40">
                        <h3 className="text-lg font-bold">Declarado ├ù Calculado</h3>
                        <div className="group relative cursor-help">
                            ...
                            <div className="absolute top-full left-0 mt-2 w-72 p-4 bg-[#0A0A0A] text-white text-[11px] rounded-xl opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none border border-slate-700 leading-relaxed drop-shadow-[0_10px_20px_rgba(0,0,0,0.8)] z-50">
                                ...
                                <p className="mb-2">Compara a <strong>autopercep├º├úo</strong> da empresa (o n├¡vel que ela achou que tinha) com a <strong>realidade</strong> apontada pelo algoritmo.</p>
                                <ul className="space-y-1.5 opacity-90">
                                    ...
                                    <li><span className="inline-block w-2.5 h-2.5 rounded-sm bg-[#F59E0B] mr-1.5"></span><strong>Acima (laranja):</strong> Ilus├úo de maturidade (superestimou).</li>
                            ...
                            <thead>
                                <tr>
                                    <th className="text-left pb-3 pr-2 w-32">
                                        <span className="text-[9px] text-gray-500 dark:text-gray-300 dark:text-gray-500 font-normal leading-tight block">declarado Ôåô<br />calculado ÔåÆ</span>
                                    </th>
                                            ...
                                            return (
                                                <td key={ci} className="py-1 px-1 text-center">
                                                    <div
                                                        ...
                                                        title={count > 0 ? `${rowLevel} ÔåÆ ${MATURITY_LEVELS[ci]}: ${count} empresa${count !== 1 ? 's' : ''}` : undefined}
                                                    >
                                                        {count > 0 ? count : '┬À'}
                                                    </div>
                                                </td>
